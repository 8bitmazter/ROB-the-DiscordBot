...
const welcomeMessage = new Discord.RichEmbed()
        ...
        .setTitle("Welcome to Misfit Heroes Games")
        ...
        .addBlankField()
        .addBlankField()
        .addField("For those of you who are new to Discord don't be afraid to reach out to the Captain for assistance. Or you may a take look at this for a quick walk through:" + url("https://www.youtube.com/watch?v=zZ08Fbs5LpM"))
        .addBlankField()
